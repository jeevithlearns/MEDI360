...
function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Action Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Link to="/chat" className="card hover:shadow-lg transition-shadow border-t-4 border-primary-500">
          <FaComments className="text-4xl text-primary-600 mb-4" />
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Medical Chat</h3>
          <p className="text-xs text-gray-600">Symptom checker and AI consultations</p>
        </Link>

        <Link to="/food-tracking" className="card hover:shadow-lg transition-shadow border-t-4 border-green-500">
          <FaUtensils className="text-4xl text-green-600 mb-4" />
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Food Diary</h3>
          <p className="text-xs text-gray-600">Log meals and track daily nutrition</p>
        </Link>

        <Link to="/exercise-tracking" className="card hover:shadow-lg transition-shadow border-t-4 border-orange-500">
          <FaRunning className="text-4xl text-orange-600 mb-4" />
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Exercise Log</h3>
          <p className="text-xs text-gray-600">Record workouts and activity levels</p>
        </Link>

        <Link to="/health-dashboard" className="card hover:shadow-lg transition-shadow border-t-4 border-purple-500">
          <FaHeartbeat className="text-4xl text-purple-600 mb-4" />
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Health Hub</h3>
          <p className="text-xs text-gray-600">Unified view of your health insights</p>
        </Link>
      </div>
